...
public class VariableTheme {
    public static void main(String[] arg) {
        ...
        System.out.println("Имя компьютера- " + str + " на 100 " + numE + "\n" +
            "Наличие Wifi- " + wifi +"\n" +
        ...
        System.out.println("Общая стоимость товаров без скидки = " + (numH + numI) + " руб.\n" +
            "Сумма скидки = " + ((numH + numI) * numK) + " руб.\n" +
            "Общая стоимость товаров со скидкой = " + ((numH + numI) - 
            ((numH + numI) * numK)) + " руб.\n");
        ...
        System.out.println(numBa + "   " + numBaa + "\n" +
            numX + "   " + numXa + "\n" +
            numW + "   " + numWa + "\n" +
            numZ + "   " + numZa + "\n" +
            numAa + "   " + numAaa + "\n");
        ...
        System.out.println("    " + numCa + numDa + "    " + "\n" +
            "   " + numCa + "  " + numDa + "   " + "\n" +
            "  " + numCa + numEa + numFa + " " + numGa + numDa + "\n" +
            " " + numCa + "      " + numDa + " " + "\n" +
            numCa + numEa + numEa + numEa + numEa + numCa + numDa + numEa + numEa + numDa + "\n");

        int numL = 123;
        int numM = numL / 100;
        int numN = numL % 100 / 10;
        int numO = numL % 10 / 1;
        System.out.println("8. Вывод количества сотен, десятков и единиц числа:");
        System.out.println("Число numL содержит: ");
        System.out.println("сотен - " + numM);
        System.out.println("десятков - " + numN);
        System.out.println("единиц - " + numO);
